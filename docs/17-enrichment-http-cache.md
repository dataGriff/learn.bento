...
> If you have the repo cloned, you can run this example with `make ex11` or `bento -c examples/11-enrichment-http-cache/config.yaml`.
...
output:
  file:
    path:  ./examples/11-enrichment-http-cache/out/enriched.jsonl
    codec: lines
```
