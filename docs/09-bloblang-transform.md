...
> If you have the repo cloned, you can run this example with `make ex04` or `bento -c examples/04-bloblang-transform/config.yaml`.
...
output:
  file:
    path:  ./examples/04-bloblang-transform/out/events.jsonl
    codec: lines
```
